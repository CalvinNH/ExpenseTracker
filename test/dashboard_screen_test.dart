...
void main() {
  ...
  testWidgets('Dashboard Screen builds and shows empty state for transactions', (WidgetTester tester) async {
    // Seed database with an account but no transactions
    final db = AppDatabase.instance;
    await db.createAccount(const Account(
      bankName: 'HDFC Bank',
  ...
  testWidgets('Dashboard Screen search button filters transactions by merchant description',
